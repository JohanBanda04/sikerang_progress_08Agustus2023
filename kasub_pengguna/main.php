...
<!--                <a href="index.php?p=history_kasub_table" class="small-box-footer">Info Lebih Lanjut <i class="fa fa-arrow-circle-right"></i></a>-->
                <a href="index.php?p=history_kasub_table&pa=history_kasub_pengguna" class="small-box-footer" style="border-bottom-left-radius: 25px; border-bottom-right-radius: 25px ">Info Lebih Lanjut <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
