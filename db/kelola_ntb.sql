...
) ENGINE = MyISAM AUTO_INCREMENT = 339 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Dynamic;
...
) ENGINE = MyISAM AUTO_INCREMENT = 421 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sementara
-- ----------------------------
INSERT INTO `sementara` VALUES (410, 'Undar', 23, 'pengguna', '1.01.03.01.001.000204', 1, 2, '2023-02-28', 0, 0, 1, 1, 'Selesai', 'Sinar', 21, NULL, NULL, NULL, 'assets/file/WhatsApp Image 2023-07-27 at 11.48.14.jpeg');
...
INSERT INTO `stokbarang` VALUES (77, '1.01.03.01.001.000142', 21, 'Sinar', 1, 'BOLPOINT FASTER I', '2750', 'BH', 20, 18, 2, '', NULL);
...
INSERT INTO `stokbarang` VALUES (173, '1.01.03.05.005.000010', 21, 'Sinar', 3, 'SILICON', '40000', 'BH', 0, 0, 0, '', NULL);
...
INSERT INTO `stokbarang` VALUES (180, '1.01.03.06.002.000180', 21, 'Sinar', 3, 'BOLA LAMPU', '35000', 'BH', 0, 0, 0, '', NULL);
...
INSERT INTO `stokbarang` VALUES (232, '1.01.03.99.999.000069', 21, 'Sinar', 2, 'TISU PASEO', '8450', 'BH', 0, 0, 0, '', NULL);
