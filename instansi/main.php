        ...
        <!-- ./col -->
          ...
          <div class="col-lg-4 col-xs-12">
              ...
              <div class="small-box bg-green" style="border-radius: 25px">
                  ...
                  <!--<a href="index.php?p=history_permintaan_barang_table" class="small-box-footer">Info Lebih Lanjut <i class="fa fa-arrow-circle-right"></i></a>-->
                  <a href="index.php?p=history_permintaan_barang_table&pa=history_pengguna" class="small-box-footer" style="border-bottom-left-radius: 25px; border-bottom-right-radius: 25px ">Info Lebih Lanjut <i class="fa fa-arrow-circle-right"></i></a>
              </div>
          </div>
          ...
          <div class="col-lg-4 col-xs-12">
              ...
              <div class="small-box bg-orange-active" style="border-radius: 25px">
                  ...
                  <!--<a href="index.php?p=cetak_bpp_baru_table" class="small-box-footer">Info Lebih Lanjut <i class="fa fa-arrow-circle-right"></i></a>-->
                  <a href="index.php?p=cetak_bpp_baru_table_v2&pa=Cetak" class="small-box-footer" style="border-bottom-left-radius: 25px; border-bottom-right-radius: 25px ">Info Lebih Lanjut <i class="fa fa-arrow-circle-right"></i></a>
              </div>
          </div>
