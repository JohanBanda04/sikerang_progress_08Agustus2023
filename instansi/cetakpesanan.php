...
where username='$_SESSION[username]' and id_user='$_SESSION[user_id]'");
        ...
        <table class="tabel2">
            ...
            <tr>
                ...
                <td style="text-align: center; width=89px;"><b>Satuan</b></td>
...
and sementara.bendahara_id='$bendahara_id' and permintaan.status='1'");
        ...
        <table class="tabel2">
            <tr>
                <td style="text-align: center; width=436px;"><b>Total Barang</b></td>
...
?>
    ...
    <div class="kanan">
        ...
        $query_get_nama_bendahara = mysqli_query($koneksi,"select nama_lengkap from user where id_user='$operator_id'");
        $row = mysqli_fetch_assoc($query_get_nama_bendahara);

        $nama_lengkap_bendahara = $row['nama_lengkap'];
        ?>
