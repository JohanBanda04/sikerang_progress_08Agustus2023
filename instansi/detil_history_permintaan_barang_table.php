...
if (isset($_GET['unit']) && isset($_GET['user_id']) && isset($_GET['tgl_permintaan'])) {
    ...
    $kode_brg_lengkap = $_GET['kode_brg_lengkap'];
    ...
    if(isset($_GET['kode_brg_lengkap'])){
        ...
        if($_GET['kode_brg_lengkap']!=""){
            //echo "ada kode brg dan terset"; die;
...
('Permintaan Baru','Pengajuan Kasub')");
            ...
            //echo "tidak ada kode brg dan terset"; die;
...
('Permintaan Baru','Pengajuan Kasub')");
        ...
        echo "tidak ada kode brg dan tidak terset"; die;
