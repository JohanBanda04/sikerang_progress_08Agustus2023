    ...
    <div class="isi" style="margin: 0 auto;">
        ...
        <table class="tabel2">
            ...
            <tr>
                ...
                <td style="text-align: center; width=60px; font-size: 12px;"><b>Harga Barang</b></td>
...
status=1 and tgl_pengajuan BETWEEN '$tanggala' AND '$tanggalb' order by tgl_pengajuan");
        ...
        ?>
        <!--bekap tabel responsive-->
        <table class="tabel2">
            <tr>
                <td style="text-align: center; width=499px;"><b>Sub Total</b></td>
                <td style="text-align: center; width=50px;"><b><?= $data2['SUM(jumlah)']; ?> </b></td>
                <td style="text-align: center; width=61px;"><b><?= number_format($data2['SUM(hargabarang)']); ?></b></td>
                <td style="text-align: center; width=70px;"><b><?= number_format($data2['SUM(total)']); ?></b></td>
            </tr>
        </table>
    </div>
