...
<table>
  <tr>
      ...
      <th rowspan="3"><img src="../gambar/lobar_logo_png.png" style="width:80px;height:100px; margin-left: 10px" /></th>
      ...
      <th rowspan="1"><img src="../gambar/rsam_narmada_png.png" style="width:95px;height:95px; margin-left: -10px"/></th>
    ...
    <table class="tabel2">      
      <thead>
        <tr>
         ...
         <td style="text-align: center; width=20px;"><b>Kode Barang</b></td>
         <td style="text-align: center; width=50px;"><b>Nama Barang</b></td>
...
//  $data2 = mysqli_fetch_array($query2);
  ...
  <table class="tabel2">
    <tr>
        <td style="text-align: center; width=498px;"><b>Sub Total</b></td>
        <td style="text-align: center; width=50px;"><b><?php echo number_format($total_jumlah); ?> </b></td>
        <td style="text-align: center; width=70px;"><b><?php echo number_format($total_harga_barang) ?>.- </b></td>
        <td style="text-align: center; width=70px;"><b><?php echo number_format($total_harga_barang_semua)?>.-</b></td>
    </tr>
