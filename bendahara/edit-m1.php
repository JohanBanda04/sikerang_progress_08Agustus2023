                    ...
                    <form method="post" action="edit-proses-m1.php" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <input type="reset"
                                   ...
                                   value="Batal">
<!--                            <a href="index.php?p=material-m1&id_jenis=1" style="margin:10px;" class="btn btn-success">-->
                            <a href="index.php?p=material-m1&id_jenis=1&pas=atk" style="margin:10px;" class="btn btn-success">
